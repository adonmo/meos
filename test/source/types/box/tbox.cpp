...
TEST_CASE("TBoxes are constructed and serialized properly", "[tbox]") {
  ...
  SECTION("<double, time_point, double, time_point> constructor") {
    ...
    output << tbox;
    REQUIRE(output.str() == "TBOX((1, 2012-01-01T00:00:00+0000), (2, 2012-01-02T00:00:00+0000))");
  }
  ...
  SECTION("<time_point, time_point> constructor") {
    ...
    output << tbox;
    REQUIRE(output.str() == "TBOX((, 2012-01-01T00:00:00+0000), (, 2012-01-02T00:00:00+0000))");
  }
  ...
  SECTION("<string> constructor") {
    TBox tbox("TBOX((1, 2012-01-01T00:00:00+0000), (2, 2012-01-02T00:00:00+0000))");
    output << tbox;
    REQUIRE(tbox.xmin() == 1);
