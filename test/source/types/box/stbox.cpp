  ...
  SECTION("geodetic constructors") {
    SECTION("GEODSTBOX T") {
      SECTION("with xyz") {
        ...
        SECTION("time as string") {
          stbox =
              STBox(11, 12, 13, "2012-01-01", 21, 22, 23, "2012-01-02", true);
        }
    ...
    SECTION("GEODSTBOX") {
      stbox = STBox(11, 12, 13, 21, 22, 23, true);
      expected = "GEODSTBOX((11, 12, 13), (21, 22, 23))";
    }
  }

  SECTION("string constructor") {
    stbox = STBox("STBOX ZT((11.0, 12.0, 13.0, 2001-01-04), "
    ...
    expected = "STBOX ZT((11, 12, 13, 2001-01-04T00:00:00+0000), "
