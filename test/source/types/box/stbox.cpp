...
TEST_CASE("STBoxes are constructed and serialized properly", "[stbox]") {
  ...
  SECTION("STBOX ZT") {
    SECTION("time as time_point") {
      stbox
          = STBox(11, 12, 13, unix_time_point(2012, 1, 1), 21, 22, 23, unix_time_point(2012, 1, 2));
    }

    SECTION("time as string") { stbox = STBox(11, 12, 13, "2012-01-01", 21, 22, 23, "2012-01-02"); }
    expected
        = "STBOX ZT((11, 12, 13, 2012-01-01T00:00:00+0000), "
  ...
  SECTION("STBOX T") {
    SECTION("with xy") {
      SECTION("time as time_point") {
        stbox = STBox(11, 12, unix_time_point(2012, 1, 1), 21, 22, unix_time_point(2012, 1, 2));
      }

      SECTION("time as string") { stbox = STBox(11, 12, "2012-01-01", 21, 22, "2012-01-02"); }
      expected
          = "STBOX T((11, 12, 2012-01-01T00:00:00+0000), "
            "(21, 22, 2012-01-02T00:00:00+0000))";
    }
    SECTION("without xy") {
      SECTION("time as time_point") {
        stbox = STBox(unix_time_point(2012, 1, 1), unix_time_point(2012, 1, 2), SRID_DEFAULT);
      }

      SECTION("time as string") { stbox = STBox("2012-01-01", "2012-01-02"); }

      expected
          = "STBOX T(( , , 2012-01-01T00:00:00+0000), ( , , "
    ...
    SECTION("GEODSTBOX T") {
      SECTION("with xyz") {
        ...
        SECTION("time as string") {
          stbox = STBox(11, 12, 13, "2012-01-01", 21, 22, 23, "2012-01-02", SRID_DEFAULT, true);
        }
        expected
      ...
      SECTION("without xyz") {
        SECTION("GEODSTBOX T") {
          ...
          expected
              = "GEODSTBOX T(( , , 2012-01-01T00:00:00+0000), "
                "( , , 2012-01-02T00:00:00+0000))";
        }
      }
    }
  ...
  SECTION("constructors with SRID specified") {
    SECTION("STBOX T") {
      stbox = STBox(11, 12, unix_time_point(2012, 1, 1), 21, 22, unix_time_point(2012, 1, 2), 5676);
      expected
          = "SRID=5676;STBOX T((11, 12, 2012-01-01T00:00:00+0000), "
            "(21, 22, 2012-01-02T00:00:00+0000))";
    }
    SECTION("GEODSTBOX") {
  ...
  SECTION("string constructor") {
    stbox = STBox(
        "SRID=4326;STBOX ZT((11.0, 12.0, 13.0, 2001-01-04), "
    ...
    expected
        = "SRID=4326;STBOX ZT((11, 12, 13, 2001-01-04T00:00:00+0000), "
...
TEST_CASE("STBoxes throw when constructed with bad arguments", "[stbox]") {
  SECTION("throw when SRID specified, but coordinates not present") {
    SECTION("string constructor") {
      REQUIRE_THROWS_AS((STBox{"SRID=4326;GEODSTBOX T(( , , 2012-01-01T00:00:00+0000), "
                               "( , , 2012-01-02T00:00:00+0000))"}),
                        std::invalid_argument);
    }
    SECTION("two strings constructor") {
      REQUIRE_THROWS_AS((STBox{"2012-01-01", "2012-01-02", 4326, true}), std::invalid_argument);
    }
  }
}