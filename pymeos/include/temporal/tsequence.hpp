...
template <> void _def_tsequence_class_specializations(py_tsequence<Geometry> &c,
                                                      std::string const &typesuffix) {
  c.def(py::init<set<TInstant<Geometry>> &, bool, bool, int, Interpolation>(), py::arg("instants"),
